  ...
  private createForm() {
    this.entretienForm = new FormBuilder().group({
      ...
      agent: new FormBuilder().group({
        id: [DEFAULT_ENTRETIEN.agent.id, [Validators.required]],
        matricule: [DEFAULT_ENTRETIEN.agent.matricule],
        nomUsage: [DEFAULT_ENTRETIEN.agent.nomUsage],
        nom: [
          DEFAULT_ENTRETIEN.agent.nom,
          [
            Validators.required,
        ...
        prenom: [
          DEFAULT_ENTRETIEN.agent.prenom,
          [
            Validators.required,
            Validators.minLength(2),
            Validators.maxLength(100),
        ...
        dateNaissance: [
          DEFAULT_ENTRETIEN.agent.dateNaissance,
          [Validators.required],
        ],
        corpsGrade: [DEFAULT_ENTRETIEN.agent.corpsGrade, [Validators.required]],
        echelon: [DEFAULT_ENTRETIEN.agent.echelon, [Validators.required]],
        datePromotion: [DEFAULT_ENTRETIEN.agent.datePromotion],
        fonction: [DEFAULT_ENTRETIEN.agent.fonction],
        structure: [DEFAULT_ENTRETIEN.agent.structure],
        adresse: [DEFAULT_ENTRETIEN.agent.adresse]
      }),
      ...
      dateAffectation: [
        DEFAULT_ENTRETIEN.dateAffectation,
        [Validators.required],
      ],
      ...
      quotiteAffectation: [
        DEFAULT_ENTRETIEN.quotiteAffectation,
        [Validators.required],
      ],
      ...
      // 2
      rappelObjectifs: [
        DEFAULT_ENTRETIEN.rappelObjectifs,
        [Validators.required],
      ],
      evenementsSurvenus: [
        DEFAULT_ENTRETIEN.evenementsSurvenus,
        [Validators.required],
      ],
      ...
      realisationObjectifs: [
        DEFAULT_ENTRETIEN.realisationObjectifs,
        [Validators.required],
      ],
      appreciationLitterale: [
        DEFAULT_ENTRETIEN.appreciationLitterale,
        [Validators.required],
      ],

      // 4
      acquisExperiencePro: [
        DEFAULT_ENTRETIEN.acquisExperiencePro,
        [Validators.required],
      ],

      // 5
      objectifsActivites: [
        DEFAULT_ENTRETIEN.objectifsActivites,
        [Validators.required],
      ],
      demarcheEnvisagee: [
        DEFAULT_ENTRETIEN.demarcheEnvisagee,
        [Validators.required],
      ],
      ...
      evolutionActivites: [
        DEFAULT_ENTRETIEN.evolutionActivites,
        [Validators.required],
      ],
      evolutionCarriere: [
        DEFAULT_ENTRETIEN.evolutionCarriere,
        [Validators.required],
      ],
    });
    ...
    try {
      datas.patchValue({
        dateEntretien: this.dateService.formatDateOrEmpty(
          datas.get('dateEntretien')?.value
        ),
        dateAffectation: this.dateService.formatDateOrEmpty(
          datas.get('dateAffectation')?.value
        ),
        agent: {
